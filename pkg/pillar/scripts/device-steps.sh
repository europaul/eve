...
FIRSTBOOT=
AGENTS="diag monitor zedagent ledmanager nim nodeagent domainmgr loguploader tpmmgr vaultmgr proxy zedmanager zedrouter downloader verifier baseosmgr wstunnelclient volumemgr watcher zfsmanager usbmanager zedkube vcomlink"
