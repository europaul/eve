...
// $ sudo modprobe vsock vsock_loopback
...
func TestMain(m *testing.M) {
	...
	// TODO : remove this
	if err := etpm.CreateKey(log, etpm.TpmDevicePath, etpm.TpmAIKHdl, tpm2.HandleOwner, etpm.DefaultAikTemplate, false); err != nil {
		fmt.Printf("failed to create AIK: %v", err)
		os.Exit(1)
	}
